...
function CategoryManagement({ categories, onCategoriesChange, showToast }) {
    ...
    <div className="panel-stack">
      <div className="grid-3">
        ...
        <div className="card metric-card" style={{ '--metric-accent': 'var(--warning)', '--metric-soft': 'var(--warning-soft)' }}>
          ...
          <div>
            <div className="metric-label">Selected Category Usage</div>
            <div className="metric-value">{categoryUsageCount} Records</div>
          </div>
        </div>
      </div>
